...
@emp = Employee.create(first_name: "ABC", last_name: "DEF", hourly_rate: 60, :store => @store1)
puts "Your password is #{@emp.password}"
@emp.save
...
@empty_store = Store.create!(name: 'Test Empty Store', annual_revenue: 10000, mens_apparel: true)
